  ...
  return (
    <div className='px-3 my-5 bg-black py-8 flex-col justify-center items-center'>
      ...
      <div className='flex gap-10 overflow-x-scroll'>
        ...
        {ads.map(ad =>
          <AdsCard key={ad.id} id={ad.id} image={ad.image} title={ad.description} amt={ad.amt}/>
        )}
      ...
      <h1 className="text-gray-400 text-md mt-4 text-center flex justify-center">
        Vorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac aliquet
        odio mattis.
      </h1>
    </div>
  )
